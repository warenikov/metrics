...
// # Generated code
//
// internal/proto contains code generated by protoc-gen-go/protoc-gen-go-grpc
// from api/metrics.proto. Unlike the custom noexit analyzer (which skips
// "DO NOT EDIT" files on its own), the standard passes — notably
// fieldalignment — have no such built-in exemption and will flag struct
// layout in generated code that must not be hand-edited. Exclude that
// package when running against the whole project:
//
//	go run ./cmd/staticlint $(go list ./... | grep -v /internal/proto)
//
// # Included analyzers
//
